...
- **git merge <ветка>** – Слить указанную ветку в текущую`}],[me.JS]:[{title:"📚 Типы данных",items:[{title:"🔢 Примитивные типы данных",text:`- **string** – Строка: "Hello", 'world', template
...
- ❌ Мутирует объект
`}]}],[me.Arrays]:[{title:"📊 Методы массива",items:[{title:"push – Добавление в конец",text:`\`\`\`js
const arr = [1, 2]
arr.push(3) // [1, 2, 3]
\`\`\`
...
- ✅ Не мутирует массив
- ✅ Удобен для создания строк`}]}],[me.Markup]:[{title:"🧱 Основные HTML-теги",items:[{title:"Структура документа и разметка",text:`\`\`\`html
...
- Дополнительные возможности для глубокого анализа и инспекции`}]}],[me.Vue]:[{title:"🖖 Vue — директивы",text:`- **v-if** – Условный рендеринг элемента (если условие true — отрисовывается)
...
`}],[me.Hotkeys]:[{title:"🔄 Редактирование и работа с кодом",text:`- **Ctrl + D** – Дублировать строку/блок
